...
default_settings['font_size'] = f'{default_settings["font_size_num"]}sp'
...
class BeeCalc(App):
    ...
    def build(self):
        ...
        textoutput_params = dict(text='',
                                 multiline=True,
                                 background_color=colors['background_output'],
                                 cursor_color=colors['cursor'],
